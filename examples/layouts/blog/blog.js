  ...
  return (
    <Base>
      ...
      <Grid id="layout">
          ...
          <div className="header">
            ...
            <nav className="nav">
              <ul className="nav-list">
                ...
                <li className="nav-item">
                  <Button as="a" href="http://yuilibrary.com">
                    YUI Library
                  </Button>
                </li>
              </ul>
        ...
        <Grid.Unit width={[1, 1 / 4]} className="content">
          <div>
            <div className="posts">
              ...
              <section className="post">
                <header className="post-header">
                  ...
                  <p className="post-meta">
                    ...
                    under
                    {" "}
                    <a className="post-category post-category-design" href="#">
                      CSS
                    </a>
                    {" "}
            ...
            <div className="posts">
              ...
              <section className="post">
                <header className="post-header">
                  ...
                  <p className="post-meta">
                    ...
                    under
                    {" "}
                    <a className="post-category post-category-js" href="#">
                      JavaScript
                    </a>
                  </p>
                </header>
              ...
              <section className="post">
                ...
                <Grid.Unit className="post-description">
                  <Grid class="post-images">
                    <Grid.Unit width={[1, 1 / 2]}>
                      {" "}
                      <a href="http://www.flickr.com/photos/uberlife/8915936174/">
                        <img
                          alt="Someone working poolside at a resort"
              ...
              <section className="post">
                <header className="post-header">
                  ...
                  <p className="post-meta">
                    ...
                    under
                    {" "}
                    <a className="post-category post-category-yui" href="#">
                      YUI
                    </a>
                  </p>
                </header>
                ...
                <div className="post-description">
                  <p>
                    We are happy to announce the release of YUI 3.10.2! You can
                    find it now on the Yahoo! CDN, download it directly, or pull
                    it in via npm. We’ve also updated the YUI Library website
        ...
        <footer className="footer">
          <Menu as="ul" horizontal>
            <Menu.Item as="li">
              <a href="http://purecss.io/" className="link">
                About
              </a>
            </Menu.Item>
            <Menu.Item as="li">
              <a href="http://twitter.com/yuilibrary/" className="link">
                Twitter
              </a>
            </Menu.Item>
            <Menu.Item as="li">
              <a href="http://github.com/pure-css/pure/" className="link">
                GitHub
              </a>
            </Menu.Item>
          </Menu>
